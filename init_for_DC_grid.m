...
%make_initialState(model,model_constants_1A,16.18/30,1,'initialState_1A');

model_constants_1B = struct(...
    'nominal_voltage',100,...
    'rated_capacity',1.5,...
    'initial_SOC',99,...
    'battery_response_time',2,...
    ...
    'capacity_at_nominal_voltage',1.3565,...
    'exponential_zone',[108.0386 0.07369565]);
%make_initialState(model,model_constants_1B,16.18/30,1,'initialState_1B');

model_constants_1C = struct(...
    'nominal_voltage',100,...
    'rated_capacity',1.5,...
    'initial_SOC',30,...
    'battery_response_time',2,...
    ...
    'capacity_at_nominal_voltage',1.3565,...
    'exponential_zone',[108.0386 0.07369565]);
%make_initialState(model,model_constants_1C,16.18/30,1,'initialState_1C');

model_constants_2X = struct(...
    'nominal_voltage',100,...
    'rated_capacity',1.5,...
    'initial_SOC',70,...
    'battery_response_time',2,...
    ...
    'capacity_at_nominal_voltage',1.3565,...
    'exponential_zone',[108.0386 0.07369565]);
%make_initialState(model,model_constants_2X,0,9,'initialState_2X'); % No load for initialization

model_constants_1_5Ah = struct(...
    'nominal_voltage',100,...
    'rated_capacity',1.5,...
    'initial_SOC',70,...
    'battery_response_time',2,...
    ...
    'capacity_at_nominal_voltage',1.3565,...
    'exponential_zone',[108.0386 0.07369565]);
make_initialState(model,model_constants_1_5Ah,0,9,'initialState_1_5Ah'); % No load for initialization
